const TRANSLATIONS = {
  en: {
    ...
    'popup.overlay.disabled': 'Overlay control',
    ...
    'popup.overlay.disabled.title': 'Tap to open or close the overlay',
